...
namespace awiko {
    ...
    void menu() {
        ...
        while (!(std::cin >> choice) || choice < 1 || choice > 15) {
            ...
            std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n'); // Ignorowanie b��dnych danych w buforze
            std::system("cls");
        }
        ...
        case 6:
            //6. Przywracanie poprzednich wersji plik�w
        ...
        case 8:
            //8. Prze��czanie si� mi�dzy ga��ziami
